...
// Вхідні дані
// Завдання 1: Додати нове замовлення до списку замовлень
// Завдання 2: Перевірити третю страву в п'ятому замовленні
// Завдання 3: Створити новий список страв, взявши першу страву з кожного замовлення
// Завдання 4: З'єднати два замовлення в одне

// Вхідні данні
let orders = [
    Array.of("Борщ", "Салат", "Пельмени"),
    Array.of("Піцца", "Лазанья", "Тірамісу"),
    Array.of("Роли", "Місо-суп", "Темпура"), 
    Array.of("Стейк", "Фрі", "Брауні")
] 

let newOrder = Array.of("Гаспачо", "Тапас", "Паелья")
...
// Перевірити третю страву в п'ятому замовленні
let check = orders.at(4).at(2)


//Створити новий список страв, взявши першу страву з кожного замовлення
let newList = Array.from(orders, order => order[0])

// З'єднати два замовлення в одне
let combinateOrder = orders[0].concat(orders[1])


console.log(orders);
console.log(check);
console.log(newList);
console.log(combinateOrder);
